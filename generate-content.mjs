...
**${fmt(harness.price)} | ${stars(harness.rating)}**
...
### 2. ${leash.name} — Best Leash

**${fmt(leash.price)} | ${stars(leash.rating)}**
...
### 3. ${collar.name} — Best Collar / GPS

**${fmt(collar.price)} | ${stars(collar.rating)}**
...
- [Best food for ${n}s →](${links.food_post||'/blog'})
- [Best toys for ${n}s →](${links.toy_post||'/blog'})
- [${n} health guide →](${links.health_post||'/blog'})
- [${n} care hub →](${links.hub||'/breeds'})
`;
}
